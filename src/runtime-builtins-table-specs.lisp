;;;; packages/javascript/src/runtime-builtins-table-specs.lisp -- JS built-in dispatch data
;;;;
...
(defparameter *js-builtin-specs*
  `(;; Type
    ...
    ("console.table"    . ,(lambda (&rest args)
                              ...
                              +js-undefined+))
    ("console.time"     . ,(constantly +js-undefined+))
    ("console.timeEnd"  . ,(constantly +js-undefined+))
    ("console.timeLog"  . ,(constantly +js-undefined+))
    ("console.count"    . ,(constantly +js-undefined+))
    ("console.countReset" . ,(constantly +js-undefined+))
    ("console.group"    . ,(constantly +js-undefined+))
    ("console.groupEnd" . ,(constantly +js-undefined+))
    ...
    ("performance"       . ,(%js-make-object
                             ...
                             "mark" (constantly +js-undefined+)
                             "measure" (constantly +js-undefined+)
                             "getEntries" (lambda () (%js-make-array))
                             "clearMarks" (constantly +js-undefined+)))
    ;; Crypto (stub)
